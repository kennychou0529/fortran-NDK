...
cmake -DCMAKE_TOOLCHAIN_FILE=/home/thomas/build/fortran/NDK/android.toolchain.cmake -DANDROID_NDK=${NDK_ROOT} -DCMAKE_BUILD_TYPE=Release -DANDROID_ABI="armeabi-v7a" ..
